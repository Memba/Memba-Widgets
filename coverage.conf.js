...
module.exports = config => {
    config.set({
        ...
        files: [
            ...
            {
                pattern: 'src/js/kidoju.data.workerlib.js',
                served: true,
                included: false
            },
            {
            ...
            {
                pattern: 'src/js/kidoju.widgets.chargrid.js',
                served: true,
                included: true
            },
            {
            ...
            {
                pattern: 'src/js/kidoju.widgets.connector.js',
                served: true,
                included: true
            },
            {
                pattern: 'src/js/kidoju.widgets.dropdowntree.js',
                served: true,
                included: true
            },
            {
                pattern: 'src/js/kidoju.widgets.dropzone.js',
                served: true,
                included: true
            },
            {
            ...
            {
                pattern: 'src/js/kidoju.widgets.floating.js',
                served: true,
                included: true
            },
            {
                pattern: 'src/js/kidoju.widgets.formatstrip.js',
                served: true,
                included: true
            },
            {
                pattern: 'src/js/kidoju.widgets.imagelist.js',
                served: true,
                included: true
            },
            {
                pattern: 'src/js/kidoju.widgets.markdown.js',
                served: true,
                included: true
            },
            {
                pattern: 'src/js/kidoju.widgets.mathexpression.js',
                served: true,
                included: true
            },
            {
            ...
            {
                pattern: 'src/js/kidoju.widgets.messagebox.js',
                served: true,
                included: true
            },
            {
            ...
            {
                pattern: 'src/js/kidoju.widgets.multiquiz.js',
                served: true,
                included: true
            },
            {
            ...
            {
                pattern: 'src/js/kidoju.widgets.selector.js',
                served: true,
                included: true
            },
            {
                pattern: 'src/js/kidoju.widgets.social.js',
                served: true,
                included: true
            },
            {
                pattern: 'src/js/kidoju.widgets.sortablelist.js',
                served: true,
                included: true
            },
            {
            ...
            {
                pattern: 'src/js/kidoju.widgets.table.js',
                served: true,
                included: true
            },
            {
            ...
            {
                pattern: 'src/js/kidoju.widgets.vector.js',
                served: true,
                included: true
            },
            {
            ...
            {
                pattern: 'test/vendor/sinon-chai.js',
                served: true,
                included: true
            },
            {
