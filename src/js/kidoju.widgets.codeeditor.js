...
(function (f, define){
    ...
    (function ($, undefined) {
        ...
        /**
         * @class CodeEditor Widget (kendoToolBox)
         */
        var CodeEditor = Widget.extend({
            ...
            value: function(value) {
                ...
                if ($.type(value) === STRING) {
                    if (that.dropDownList instanceof kendo.ui.DropDownList && that.input instanceof $ && that.codeMirror instanceof window.CodeMirror) {
