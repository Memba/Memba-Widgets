        ...
        var StyleEditor = Widget.extend({
            ...
            value: function (value) {
                ...
                if ($.type(value) === STRING) {
                    ...
                    that._dataSource.data(data.sort(sort));
                } else if ($.type(value) === 'undefined') {
                    // Convert the data source into an HTML style attribute
                    value = '';
                    // Sorting here is not user friendly as the position changes in the grid
                    // data = that._dataSource.data().sort(sort);
                    data = that._dataSource.data().sort();
            ...
            _layout: function () {
                ...
                if ($.isFunction(that.element.kendoGrid)) {
