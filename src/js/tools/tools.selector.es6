...
import { LIB_COMMENT, arrayLibrary } from './util.library.es6';
...
var Selector = BaseTool.extend({
    ...
    templates: {
        ...
        review: format(SELECTOR, 'data-#= ns #bind="value: #: properties.name #.value, source: interactions" data-#= ns #enable="false"') + BaseTool.fn.showResult()
    },
    height: 50,
    width: 50,
    attributes: {
