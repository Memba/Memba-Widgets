...
(function(f, define) {
    ...
    function() {
        ...
        (function($, undefined) {
            ...
            const TOOLBAR_MESSAGES = (kendo.mathinput.messages.toolbar = {
                field: {
                    title: 'Field'
                },
                backspace: {
            ...
            */
            ...
            var MathInputToolBar = ToolBar.extend({
                init(element, options) {
                    ...
                    options.items = this._expandTools(
                        options.tools ||
                            MathInputToolBar.prototype.options.tools
                    );
                    ...
                    this.element.addClass(
                        'k-spreadsheet-toolbar kj-mathinput-toolbar'
                    );
                ...
                _expandTools(tools) {
                    function expandTool(toolName) {
                        ...
                        if (options.property) {
                            tool.attributes[kendo.attr('property')] =
                                options.property;
                        }
                        return tool;
                    }
                ...
                _click(e) {
                    const toolName = e.target.attr(kendo.attr('tool'));
                ...
                refresh(activeCell) {
                    ...
                    for (let i = 0; i < tools.length; i++) {
                        ...
                        const { tool } = tools[i];
                        let value = kendo.isFunction(range[property])
                            ? range[property]()
                            : range;
             ...
             * PopupTool
             */
            const PopupTool = kendo.toolbar.Item.extend({
                ...
                _popup() {
                    const { element } = this;
                    this.popup = $(
                        '<div class="k-spreadsheet-popup kj-mathinput-popup" />'
                    )
                        .appendTo(element)
         ...
         */
             ...
             */
            const OverflowDialogButton = kendo.toolbar.OverflowButton.extend({
                init(options, toolbar) {
                    kendo.toolbar.OverflowButton.fn.init.call(
                        this,
                        options,
                        toolbar
                    );
            ...
            const MatricesTool = PopupTool.extend({
                ...
                buttons: [
                    ...
                    {
                        value:
                            '\\begin{bmatrix}1&amp;2\\\\x&amp;y\\end{bmatrix}', // Square Brackets
                        iconClass: 'bmatrix',
                        text: TOOLBAR_MESSAGES.matrices.buttons.bmatrix
                    },
                    {
                        value:
                            '\\begin{Bmatrix}1&amp;2\\\\x&amp;y\\end{Bmatrix}', // Curly braces
                        iconClass: 'bbmatrix',
                        text: TOOLBAR_MESSAGES.matrices.buttons.bbmatrix
                    },
                    {
                        value:
                            '\\begin{vmatrix}1&amp;2\\\\x&amp;y\\end{vmatrix}', // Vertical line
                        iconClass: 'vmatrix',
        ...
        */
            ...
            const DIALOG_MESSAGES = (kendo.mathinput.messages.dialogs = {
                /*
            apply: 'Apply',
            save: 'Save',
            cancel: 'Cancel',
            ...
            */
             ...
             * MathInputDialog
             */
            const MathInputDialog = (kendo.mathinput.MathInputDialog = kendo.Observable.extend(
                {
                    init(options) {
                    ...
                    dialog() {
                        if (!this._dialog) {
                            this._dialog = $(
                                '<div class="k-spreadsheet-window k-action-window kj-mathinput-dialog" />'
                            )
                                .addClass(this.options.className || '')
                                .append(
                                    kendo.template(this.options.template)({
                                        messages:
                                ...
                                .kendoWindow({
                                    ...
                                    deactivate: this._onDialogDeactivate.bind(
                                        this
                                    )
                                })
                                .data('kendoWindow');
             ...
             * KeyPadDialog
             */
            const KeyPadDialog = MathInputDialog.extend({
                init(options) {
                    const messages =
                        kendo.mathinput.messages.dialogs || DIALOG_MESSAGES;
                ...
                _list() {
                    ...
                    this.list = new kendo.ui.StaticList(ul, {
                        ...
                        template:
                            '<a title="#=text#" data-value="#=value#"><span class="k-icon k-i-#=iconClass#"></span></a>',
             ...
             * BasicDialog
             */
            const BasicDialog = MathInputDialog.extend({
                init(options) {
                    const messages =
                        kendo.mathinput.messages.dialogs || DIALOG_MESSAGES;
                    const defaultOptions = {
             ...
             * GreekDialog
             */
            const GreekDialog = MathInputDialog.extend({
                init(options) {
                    const messages =
                        kendo.mathinput.messages.dialogs || DIALOG_MESSAGES;
                    const defaultOptions = {
             ...
             * OperatorsDialog
             */
            const OperatorsDialog = MathInputDialog.extend({
                init(options) {
                    const messages =
                        kendo.mathinput.messages.dialogs || DIALOG_MESSAGES;
                    const defaultOptions = {
                        ...
                        buttons: [
                            ...
                            },
                            {
                                ...
                                iconClass: 'plusminus',
                                text:
                                    DIALOG_MESSAGES.operators.buttons.plusminus
                            },
                            {
                                value: '%',
                                iconClass: 'percent',
             ...
             * ExpressionsDialog
             */
            const ExpressionsDialog = MathInputDialog.extend({
                init(options) {
                    const messages =
                        kendo.mathinput.messages.dialogs.expression ||
                        DIALOG_MESSAGES;
                    const defaultOptions = {
                        ...
                        buttons: [
                            ...
                            },
                            {
                                ...
                                iconClass: 'nthroot',
                                text:
                                    DIALOG_MESSAGES.expressions.buttons.nthroot
                            },
                            {
                                value: '^{ }',
                                iconClass: 'pow',
                            ...
                            },
                            {
                                ...
                                iconClass: 'partial',
                                text:
                                    DIALOG_MESSAGES.expressions.buttons.partial
                            },
                            {
                                value: '\\int',
                                iconClass: 'int',
             ...
             * SetsDialog
             */
            const SetsDialog = MathInputDialog.extend({
                init(options) {
                    const messages =
                        kendo.mathinput.messages.dialogs.set || DIALOG_MESSAGES;
                    const defaultOptions = {
                        title: messages.title,
                        buttons: [
                            // See also https://texblog.org/2007/08/27/number-sets-prime-natural-integer-rational-real-and-complex-in-latex/
             ...
             * MatricesDialog
             */
            const MatricesDialog = MathInputDialog.extend({
                init(options) {
                    const messages =
                        kendo.mathinput.messages.dialogs.matrices ||
                        DIALOG_MESSAGES;
                    const defaultOptions = {
                        title: messages.title,
                        buttons: [
                            ...
                            {
                                value:
                                    '\\begin{matrix}1&amp;2\\\\x&amp;y\\end{matrix}', // Bare
                                iconClass: 'matrix',
                                text: DIALOG_MESSAGES.matrices.buttons.matrix
                            },
                            {
                                value:
                                    '\\begin{pmatrix}1&amp;2\\\\x&amp;y\\end{pmatrix}', // Parenthesis
                                iconClass: 'pmatrix',
                            ...
                            {
                                value:
                                    '\\begin{Vmatrix}&amp;\\\\&amp;\\end{Vmatrix}', // Double vertical lines
                                iconClass: 'vvmatrix',
                                text: DIALOG_MESSAGES.matrices.buttons.vvmatrix
                            },
                            {
                                value:
                                    '\\begin{Vmatrix}&amp;\\\\&amp;\\end{Vmatrix}', // TODO Add column
                                iconClass: 'column',
                                text: DIALOG_MESSAGES.matrices.buttons.column
                            },
                            {
                                value:
                                    '\\begin{Vmatrix}&amp;\\\\&amp;\\end{Vmatrix}', // TODO Add row
                                iconClass: 'row',
             ...
             * StatisticsDialog
             */
            const StatisticsDialog = MathInputDialog.extend({
                init(options) {
                    const messages =
                        kendo.mathinput.messages.dialogs.statistics ||
                        DIALOG_MESSAGES;
                    const defaultOptions = {
                        title: messages.title,
                        buttons: [
                            {
                                ...
                                iconClass: 'factorial',
                                text:
                                    DIALOG_MESSAGES.statistics.buttons.factorial
                            },
                            {
                                value: '\\binom',
                                iconClass: 'binomial',
                                text:
                                    DIALOG_MESSAGES.statistics.buttons.binomial
                            },
                            {
                                value: '\\overline',
                                iconClass: 'overline',
                                text:
                                    DIALOG_MESSAGES.statistics.buttons.overline
                            }
                        ]
                    };
                    MathInputDialog.fn.init.call(
