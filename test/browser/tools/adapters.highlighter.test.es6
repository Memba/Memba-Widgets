...
import HighLighterAdapter from '../../../src/js/tools/adapters.highlighter.es6';

const { describe, it } = window;
const { expect } = chai;

describe('adapters.highlighter', () => {
    describe('HighLighterAdapter', () => {
        const adapter = new HighLighterAdapter();
