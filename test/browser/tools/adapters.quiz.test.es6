...
import QuizAdapter from '../../../src/js/tools/adapters.quiz.es6';
...
describe('adapters.quiz', () => {
    describe('QuizAdapter', () => {
        ...
        it('It should have descriptors', () => {
            ...
            expect(adapter).to.have.property('from').that.is.undefined;expect(adapter).to.have.property('from').that.is.undefined;
