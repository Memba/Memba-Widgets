...
;(function (window, undefined) {
    ...
    describe('Test PageItemCollectionDataSource', function() {
        ...
        describe('When initializing a PageItemCollectionDataSource from an improper array', function() {
            it('an exception should be raised', function () {
                /*
                var fn = kidoju.PageItemCollectionDataSource.create.bind(
                    kidoju.PageItemCollectionDataSource, //this
                    { data: [] } //paramater of method create
                );
                */
                var fn = function() {
                    var dataSource = kidoju.PageItemCollectionDataSource.create(new kendo.data.DataSource({ data: [] }));
                };
                //expect(fn).to.throw('Incorrect DataSource type. Only PageItemCollectionDataSource instances are supported');
                expect(fn).to.throw(Error);
            });
        });

        describe('When creating a PageItemCollectionDataSource from a dataSource', function() {
            it('the number of items should match', function() {
